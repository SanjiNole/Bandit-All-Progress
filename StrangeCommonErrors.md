Strange error I encountered while attempting Bandit level 3. As the video shows i typed everything in the password correctly and it will not let me pass. Will update if fixed.
